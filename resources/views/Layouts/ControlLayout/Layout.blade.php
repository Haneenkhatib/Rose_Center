...
<head>
    @include('Layouts.ControlLayout.component.header.header_meta')
</head>
<!-- END HEAD -->
...
<div class="page-wrapper">
    <!-- BEGIN HEADER -->
@includeIf('Layouts.ControlLayout.component.header.header')
    <!-- END HEADER -->
    ...
    <div class="page-container">
        ...
        <div class="page-sidebar-wrapper">
            <!-- BEGIN SIDEBAR -->
        @includeIf('Layouts.ControlLayout.component.nav')
            <!-- END SIDEBAR -->
        </div>
        <!-- END SIDEBAR -->
        <!-- BEGIN CONTENT -->
    ...
    <!-- END CONTAINER -->
    <!-- BEGIN FOOTER -->
@includeIf('Layouts.ControlLayout.component.Footer.Footer')
    <!-- END FOOTER -->
</div>
<!-- BEGIN QUICK NAV -->
<nav class="quick-nav">
...
<!-- FOOTER META STARTS -->
@includeIf('Layouts.ControlLayout.component.Footer.Footer_meta')
<!-- FOOTER META ENDS -->
</body>
