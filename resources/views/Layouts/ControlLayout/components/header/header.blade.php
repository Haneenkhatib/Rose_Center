                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                ...
                                <li>
                                    <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('/control/assets/layouts/layout3/img/avatar2.jpg')}}"
                                ...
                                <li>
                                    <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('/control/assets/layouts/layout3/img/avatar3.jpg')}}"
                                                             class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('/control/assets/layouts/layout3/img/avatar1.jpg')}}م"
                                                             class="img-circle" alt=""> </span>
                                        <span class="subject">
