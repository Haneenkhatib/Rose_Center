        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4" style="margin: auto">
                    <form class="fw-contact-form" action="{{route('appointment.update',['id' => $appointment->id])}}" method="post" >
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" value="{{$appointment->date}}" class="form-control datepicker" placeholder="Date *" name="date">
